    ...
    <>
      <div className="sugested-profile">
        <div className="sugested-profile__profile-box">
            ...
            <img className="sugested-profile__profile-image" src={avatar} alt={user} avatar/>
            </a>
            <a className="sugested-profile__profile-account" href="#!">{user}</a>
        </div>
        <a className="sugested-profile__profile-follow" href="#!">Seguir</a>
      </div>
    </>
  );
};
