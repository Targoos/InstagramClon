  ...
  return (
    <>
        ...
        <div className="login__body">
          ...
          <div className="login__body__box">
            <div className="login__body__box__form">
              <img className="login__body__box__form__logo" src={logo} alt="logo"/>
              <input
              ...
              <input
                ...
                id=""
              />
              <Link to={'/Home'} className="login__body__box__form__button" disabled>Iniciar sesión</Link>
      ...
      <div className="login-footer">
        <a className="login-footer__footer-link" href="#!">informacion</a>
        <a className="login-footer__footer-link" href="#!">ayuda</a>
        <a className="login-footer__footer-link" href="#!">prensa</a>
        <a className="login-footer__footer-link" href="#!">api</a>
        <a className="login-footer__footer-link" href="#!">empleo</a>
        <a className="login-footer__footer-link" href="#!">privacidad</a>
        <a className="login-footer__footer-link" href="#!">condiciones</a>
        <a className="login-footer__footer-link" href="#!">ubicaciones</a>
        <a className="login-footer__footer-link" href="#!">cuentas destacadas</a>
        <a className="login-footer__footer-link" href="#!">hashtags</a>
        <a className="login-footer__footer-link" href="#!">idioma</a>
